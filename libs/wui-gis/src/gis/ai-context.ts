...
export function buildSystemPrompt(contextData: string): string {
  return [
    ...
    "L'ingénieur s'en sert pour CONFIGURER un site : tracer des zones (secteurs, quartiers, bassins) et y placer des équipements liés à des datapoints, dont la carte affiche les valeurs temps réel et l'état d'alarme.",
    '',
    ...
    "- Plafonds du site : 64 zones et 1000 équipements ; au-delà l'excédent est écarté. Un « generate » est plafonné à 2000 points.",
    '',
    'Repartir de zéro : SEULEMENT si l\'utilisateur le demande explicitement (« remplace tout », « recommence »), remplace "mode": "patch" par "mode": "replace" et fournis "areas" et "assets" complets — cela SUPPRIME tout ce que tu n\'y remets pas. En cas de doute, patche et dis-le en une phrase.',
    '',
