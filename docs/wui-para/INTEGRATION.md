...
## Install (one command)
```bash
node install.mjs --workspace <workspace-runtime> --project <winccoa-project-root>
```
...
3. copies the **backend module** → `<project>/javascript/customer-webserver/src/modules/para/`;
