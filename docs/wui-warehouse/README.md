...
| Tab           | What it does                                                                                                                                                 |
| ------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Plan**      | **2D** SVG plan or **3D** three.js scene of the zones/racks, coloured by occupancy (grey empty · green · amber ≥70% · red ≥90% · blue = occupied uncapped floor). Click a location to inspect its contents. **Edit layout** (role `edit-config`) lets the operator drag zones/racks and resize them with the corner handle (2D), or drag racks on the floor plane (3D) — grid-snapped, persisted immediately. |
